...
} = require("../controllers/productVariant.controllers");
...
router.get(
  "/",
  [Auth, access("Admin")],
  ProductVariantController.getAllVariants
);
...
router.get(
  "/product/:productId/search",
  ProductVariantController.searchAttributes
);

//post requests
router.post(
  "/product/:productId/addVariant",
  [Auth, access("Seller")],
