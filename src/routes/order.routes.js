...
router.get(
  ...
  OrderController.getAllStoreOrders
);
router.get(
  "/:orderId/store/:storeId",
  [Auth, access("Seller", "Admin")],
  OrderController.getStoreOrder
);
router.get(
  "/store/:storeId/search",
  [Auth, access("Seller", "Admin")],
  OrderController.searchStoreOrders
);
...
router.get(
  "/user/:userId/search",
  [Auth, access("Buyer", "Admin")],
  OrderController.searchUserOrders
);

//post requests
router.post(
  "/user/:userId/createOrder",
  [Auth, access("Buyer")],
